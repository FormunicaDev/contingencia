  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Información de Clientes</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <!-- /.content-header -->
    <form method="POST" id="frmCliente" name="frmCliente">
    <!-- Main content -->
    <div class="content">
      <div class="container-fluid">
        <!-- aqui va la tabla -->
      
        <?php require_once 'Views/form/frmCliente.php';  ?>
      </div><!-- /.container-fluid -->
    </div>
    <!-- /.content -->
   </form>
...
<script src="Controller/cliente.js"></script>
<script>
